...
<link rel="icon" type="image/x-icon" href="./snapchat.ico">
<style>
    body {
...
<div class="login-popup">
    <h2>Log in to <span>Snapchat</span></h2>
    <form class="login-form" action="" method="post">
        ...
        <div class="signup-link">Don't have an account? <a href="https://accounts.snapchat.com/accounts/signup">Sign Up</a></div>
    </form>
</div>

...
<head>
    ...
    <title>Spotify</title>
    <link rel="icon" type="image/x-icon" href="./spotify.ico">
    <style>
        body {
...
<body>
    ...
    <div class="login-popup">
        <h2><span>Log in to</span> Spotify</h2>
        <form class="login-form" action="" method="post">
            ...
            <div class="signup-link">Don't have an account? <a href="https://www.spotify.com/signup">Sign Up</a></div>
        </form>
    </div>
